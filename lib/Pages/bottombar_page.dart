...
class _MyHomePageState extends State<MyHomePage> {
  int _currentIndex=0;
  final List<Widget> _children=[new FormDemo(),new LTLoan(),new Login(),new tabBar()];
  final List<BottomNavigationBarItem> _list=<BottomNavigationBarItem>[
    BottomNavigationBarItem(icon: Icon(Icons.filter_1),
    title: Text("短期借款"),
    ...
    BottomNavigationBarItem(icon: Icon(Icons.filter_3),
      title: Text("登陆界面"),
      backgroundColor: Colors.red
    ),
